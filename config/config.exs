...
# This module wires phoenix_live_schedule's CSS via `css_sources/0` (core's
# Tailwind sources compiler), not the package's own `mix phoenix_live_schedule.install`
